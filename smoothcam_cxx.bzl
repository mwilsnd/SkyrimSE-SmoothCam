...
DEFINES = [
    ...
    "/DAPSTONE_M68K_SUPPORT=0",
    "/DAPSTONE_MIPS_SUPPORT=0",
    "/DAPSTONE_PPC_SUPPORT=0",
    "/DAPSTONE_SPARC_SUPPORT=0",
    "/DAPSTONE_SYSZ_SUPPORT=0",
    "/DAPSTONE_XCORE_SUPPORT=0",
    "/DAPSTONE_X86_SUPPORT=1",
    "/DAPSTONE_TMS320C64X_SUPPORT=0",
    "/DAPSTONE_EVM_SUPPORT=0",
    "/DAPSTONE_ARCHITECUTRE_DEFAULT=0",
]
