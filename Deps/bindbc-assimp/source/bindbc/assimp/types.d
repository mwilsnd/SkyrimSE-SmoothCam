...
enum AI_MATKEY_MAPPINGMODE_U(aiTextureType type, uint N) = tuple(_AI_MATKEY_MAPPINGMODE_U_BASE,type,N);
...
enum AI_MATKEY_MAPPINGMODE_V(aiTextureType type, uint N) = tuple(_AI_MATKEY_MAPPINGMODE_V_BASE,type,N);
...
enum AI_MATKEY_TEXMAP_AXIS(aiTextureType type, uint N) = tuple(_AI_MATKEY_TEXMAP_AXIS_BASE,type,N);
...
enum AI_MATKEY_UVTRANSFORM(aiTextureType type, uint N) = tuple(_AI_MATKEY_UVTRANSFORM_BASE,type,N);
...
enum AI_MATKEY_TEXFLAGS(aiTextureType type, uint N) = tuple(_AI_MATKEY_TEXFLAGS_BASE,type,N);
