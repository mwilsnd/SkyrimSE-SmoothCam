...
namespace PapyrusBindings {
	...
	enum class ConfigStringMapping {
		...
		DisableDeltaTime,
		Crosshair3DMagicEnabled, Crosshair3DBowEnabled,
	...
	constexpr auto stringMap = mapbox::eternal::hash_map<mapbox::eternal::string, ConfigVar>({
		...
		{ "Enable3DBowCrosshair",				{ConfigStringMapping::Crosshair3DBowEnabled, ConfigType::BOOL} },
		{ "Enable3DMagicCrosshair",				{ConfigStringMapping::Crosshair3DMagicEnabled, ConfigType::BOOL} },
