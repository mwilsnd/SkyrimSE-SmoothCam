...
void Camera::State::ThirdpersonHorseState::OnBegin(const PlayerCharacter* player, const TESObjectREFR* cameraRef, const CorrectedPlayerCamera* camera,
	BaseCameraState* fromState)
{

}

void Camera::State::ThirdpersonHorseState::OnEnd(const PlayerCharacter* player, const TESObjectREFR* cameraRef, const CorrectedPlayerCamera* camera,
	BaseCameraState* nextState)
{
	StateHandOff(nextState);
}

void Camera::State::ThirdpersonHorseState::Update(PlayerCharacter* player, const TESObjectREFR* cameraRef, const CorrectedPlayerCamera* camera) {
